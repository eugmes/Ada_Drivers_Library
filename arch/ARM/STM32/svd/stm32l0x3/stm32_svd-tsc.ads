...
package STM32_SVD.TSC is
   ...
   type TSC_Peripheral is record
      ...
      pragma Volatile_Full_Access (IOHCR);
      --  I/O analog switch control register
      IOASCR : aliased IOASCR_Register;
      pragma Volatile_Full_Access (IOASCR);
      --  I/O sampling control register
      IOSCR  : aliased IOSCR_Register;
      pragma Volatile_Full_Access (IOSCR);
      --  I/O channel control register
      IOCCR  : aliased IOCCR_Register;
      pragma Volatile_Full_Access (IOCCR);
      --  I/O group control status register
      IOGCSR : aliased IOGCSR_Register;
      pragma Volatile_Full_Access (IOGCSR);
      --  I/O group x counter register
      IOG1CR : aliased IOG1CR_Register;
      pragma Volatile_Full_Access (IOG1CR);
      --  I/O group x counter register
      IOG2CR : aliased IOG2CR_Register;
      pragma Volatile_Full_Access (IOG2CR);
      --  I/O group x counter register
      IOG3CR : aliased IOG3CR_Register;
      pragma Volatile_Full_Access (IOG3CR);
      --  I/O group x counter register
      IOG4CR : aliased IOG4CR_Register;
      pragma Volatile_Full_Access (IOG4CR);
      --  I/O group x counter register
      IOG5CR : aliased IOG5CR_Register;
      pragma Volatile_Full_Access (IOG5CR);
      --  I/O group x counter register
      IOG6CR : aliased IOG6CR_Register;
      pragma Volatile_Full_Access (IOG6CR);
      --  I/O group x counter register
      IOG7CR : aliased IOG7CR_Register;
      pragma Volatile_Full_Access (IOG7CR);
      --  I/O group x counter register
      IOG8CR : aliased IOG8CR_Register;
      pragma Volatile_Full_Access (IOG8CR);
   end record
     with Volatile;

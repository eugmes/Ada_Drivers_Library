...
package STM32_SVD.SCB is
   ...
   type SCB_Peripheral is record
      ...
      pragma Volatile_Full_Access (SHPR2);
      --  System handler priority registers
      SHPR3 : aliased SHPR3_Register;
      pragma Volatile_Full_Access (SHPR3);
   end record
     with Volatile;

...
package STM32_SVD.LCD is
   ...
   type LCD_Peripheral is record
      ...
      pragma Volatile_Full_Access (CLR);
      --  display memory
      RAM_COM0 : aliased RAM_COM0_Register;
      pragma Volatile_Full_Access (RAM_COM0);
      --  display memory
      RAM_COM1 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM1);
      --  display memory
      RAM_COM2 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM2);
      --  display memory
      RAM_COM3 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM3);
      --  display memory
      RAM_COM4 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM4);
      --  display memory
      RAM_COM5 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM5);
      --  display memory
      RAM_COM6 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM6);
      --  display memory
      RAM_COM7 : aliased RAM_COM_Register;
      pragma Volatile_Full_Access (RAM_COM7);
   end record
     with Volatile;
